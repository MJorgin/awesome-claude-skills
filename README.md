...
- [Preflight Decks](https://github.com/MJorgin/preflight-decks) - Concept-first HTML presentation director: a hard concept gate producing three structurally different real previews, a scored critique loop, and Playwright verification at projector and phone sizes before delivery. Builds on the frontend-slides fixed-stage chassis; works with Claude Code / Codex. *By [@MJorgin](https://github.com/MJorgin)*
